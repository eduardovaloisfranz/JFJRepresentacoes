    ...
    <b-modal v-model="exibirModal" centered hide-footer title="Modificar Representação">
      ...
      <div class="d-flex flex-column align-items-center">
        ...
        <div class="d-flex justify-content-between">
          <b-button class="mr-5" @click="exibirModalEditEmpresa = true" variant="success">Modificar</b-button>
          <b-button class="ml-5" variant="danger" @click.prevent="handleApagarRepresentacao">Apagar</b-button>
        </div>
      </div>
    </b-modal>
    <b-modal v-model="exibirModalEditEmpresa" centered hide-footer title="Modificar Representação">
      <h3 class="h3 text-center text-info text-monospace">Pré-visualização do card da empresa atual</h3>
      <div class="d-flex flex-column align-items-center">
        <b-card
          :title="empresaSelecionada.nome"
          :img-src="empresaSelecionada.urlImagem"
